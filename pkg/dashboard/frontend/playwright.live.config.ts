...
// cluster (port-forwarded), seeded by tests/acceptance/kind/operational-graph.sh. Unlike
...
export default defineConfig({
  ...
  // already been proven to hold (tests/acceptance/kind/productready gates on them), so a
