import{i as e,p as t}from"./chunk-5ZQYHXKU-BB4GeSJk.js";import{d as n,r,t as i}from"./index-DGnTsslp.js";import{t as a}from"./mermaid-parser.core-DGba2cLL.js";import{n as o,r as s}from"./chunk-AGHRB4JF-CdhNSMMp.js";import{H as c,K as l,U as u,a as d,c as f,f as p,v as m,w as h,x as g,y as _}from"./chunk-CSCIHK7Q-CR08YGKa.js";import{t as v}from"./chunk-WU5MYG2G-DJaB3DTY.js";import{t as y}from"./chunk-4BX2VUAB-DkhgO4Bf.js";var b=p.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:o(()=>structuredClone(w),`getConfig`),clear:o(()=>{S=new Map,C=x.showData,d()},`clear`),setDiagramTitle:l,getDiagramTitle:h,setAccTitle:u,getAccTitle:_,setAccDescription:c,getAccDescription:m,addSection:o(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),s.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:o(()=>S,`getSections`),setShowData:o(e=>{C=e},`setShowData`),getShowData:o(()=>C,`getShowData`)},E=o((e,t)=>{y(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:o(async e=>{let t=await a(`pie`,e);s.debug(t),E(t,T)},`parse`)},O=o(e=>`
  .pieCircle{
