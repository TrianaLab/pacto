...
This chart deploys the [Pacto Operator](https://github.com/TrianaLab/pacto/tree/main/integrations/kubernetes) — a Kubernetes operator that validates running workloads against declared [Pacto](https://github.com/TrianaLab/pacto) service contracts.
