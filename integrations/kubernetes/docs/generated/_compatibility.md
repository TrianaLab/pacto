...
This documentation set corresponds to Pacto core `3.2.9`. The integration's own version (currently operator/chart `5.2.4`, docs `5.2.4`) advances on its own release cadence.
