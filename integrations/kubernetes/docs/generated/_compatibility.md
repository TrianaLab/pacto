...
| --- | --- | --- |
| Operator image | `5.4.2` | `>=3.0.0` |
| Operator chart | `5.4.2` | `>=3.0.0` |
| Go module | `5.4.2` | `>=3.0.0` |
| Integration docs | `5.4.2` | `>=3.0.0` |

This documentation set corresponds to Pacto core `3.3.3`. The integration's own version (currently operator/chart `5.4.2`, docs `5.4.2`) advances on its own release cadence.
