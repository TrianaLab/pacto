...
| --- | --- | --- |
| Operator image | `5.0.0` | `>=3.0.0` |
| Operator chart | `5.0.0` | `>=3.0.0` |
| Go module | `5.0.0` | `>=3.0.0` |
| Integration docs | `5.0.0` | `>=3.0.0` |

This documentation set corresponds to Pacto core `3.0.1`. The integration's own version (currently operator/chart `5.0.0`, docs `5.0.0`) advances on its own release cadence.
