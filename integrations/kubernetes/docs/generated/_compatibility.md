...
This documentation set corresponds to Pacto core `3.3.2`. The integration's own version (currently operator/chart `5.4.1`, docs `5.4.1`) advances on its own release cadence.
