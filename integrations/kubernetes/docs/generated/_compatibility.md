...
This documentation set corresponds to Pacto core `3.2.3`. The integration's own version (currently operator/chart `5.2.3`, docs `5.2.3`) advances on its own release cadence.
