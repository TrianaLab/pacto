...
This documentation set corresponds to Pacto core `3.1.2`. The integration's own version (currently operator/chart `5.1.2`, docs `5.1.2`) advances on its own release cadence.
