...
| --- | --- | --- | --- |
| Controller image | oci-image | `ghcr.io/trianalab/pacto/operator` | `5.3.0` |
| Helm chart | helm-chart | `ghcr.io/trianalab/pacto/charts/pacto-operator` | `5.3.0` |
| Go module | go-module | `github.com/trianalab/pacto/integrations/kubernetes/v5` | `5.3.0` |
| Documentation | docs | `mkdocs:integrations/kubernetes` | `5.3.0` |
...
cosign verify \
  ...
  ghcr.io/trianalab/pacto/operator:5.3.0
```
...
- name: pacto-controller
  image: ghcr.io/trianalab/pacto/operator:5.3.0
```
