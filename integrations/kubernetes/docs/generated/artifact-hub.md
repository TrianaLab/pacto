...
| --- | --- | --- | --- |
| Controller image | oci-image | `ghcr.io/trianalab/pacto/operator` | `5.2.1` |
| Helm chart | helm-chart | `ghcr.io/trianalab/pacto/charts/pacto-operator` | `5.2.1` |
...
- name: pacto-controller
  image: ghcr.io/trianalab/pacto/operator:5.2.1
```
