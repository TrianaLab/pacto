...
beat_args() {
  case "$1" in
    ...
    5)  echo "diff examples/demo/bundles/payments-service/v1.2.0 examples/demo/bundles/payments-service/v2.0.0" ;;
    6)  echo "diff examples/demo/bundles/payments-service/v1.0.0 examples/demo/bundles/payments-service/v1.1.0" ;;
    7)  echo "impact examples/demo/bundles/payments-service/v1.2.0 examples/demo/bundles/payments-service/v2.0.0 --local examples/demo/bundles" ;;
    8)  echo "impact examples/demo/bundles/payments-service/v1.2.0 examples/demo/bundles/payments-service/v2.0.0 --local examples/demo/bundles --traces examples/demo/traces.json" ;;
    9)  echo "impact examples/demo/bundles/payments-service/v1.2.0 examples/demo/bundles/payments-service/v2.0.0 --local examples/demo/bundles --traces examples/demo/traces.json --target-state examples/demo/fleet-targets.yaml" ;;
