...
```bash
pacto impact examples/demo/bundles/payments-service/v1.2.0 examples/demo/bundles/payments-service/v2.0.0 --local examples/demo/bundles --traces examples/demo/traces.json
```
