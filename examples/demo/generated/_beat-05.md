...
```bash
pacto diff examples/demo/bundles/payments-service/v1.2.0 examples/demo/bundles/payments-service/v2.0.0
```

```console
Classification: BREAKING
Changes (30):
  [NON_BREAKING] service.version (modified): service.version modified [1.2.0 -> 2.0.0]
