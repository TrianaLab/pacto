...
The dashboard merges local, OCI and Kubernetes sources into one fleet view; deploy the [container image](https://pacto.run/latest/dashboard-docker) alongside the operator to combine runtime state with contract data.
