...
- fa6d27a: Take the week's dependency bumps in one go: `modelcontextprotocol/go-sdk`
...
- 12b7c03: Gate the documentation deterministically, and cut the corpus to fit the gate.
